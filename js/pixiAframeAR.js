...
window.onload = function () {
	...
	function loadAssets() {
		...
		var p1 = new Promise(function (resolve, reject) {
			...
			loader.add('model3', "assets/C97_Ina/C97_Ina.model3.json", xhrType);
			loader.add('motion1', "assets/C97_Ina/motions/C97_Ina1.motion3.json", xhrType);
			loader.add('motion2', "assets/C97_Ina/motions/C97_Ina1.motion3.json", xhrType);
